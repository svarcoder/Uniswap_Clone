...
import {
	...
	MenuCountEl,
	MenuCountElTitle,
	MenuCountElDescription,
	MenuEcoSystem,
	MenuEcoSystemLeft,
	MenuEcoSystemLeftTitle,
	MenuEcoSystemLeftDescription,
	MenuEcoSystemLeftMiniDescription,
	MenuEcoSystemRight,
	MenuEcoSystemRightLogo,
	MenuEcoSystemRightLogoTitle,
	MenuEcoSystemRightLogoDescription,
	MenuEcoSystemRightExplore,
	MenuDeveloper,
	MenuDeveloperTitle,
	MenuDeveloperRest,
	MenuDeveloperEl1,
	MenuDeveloperEl1Title,
	MenuDeveloperEl1Description,
	MenuDeveloperEl1Explore,
	MenuDeveloperEl2,
	MenuDeveloperEl2Logo,
	MenuDeveloperEl2Description,
	MenuDeveloperEl2Title,
	MenuDeveloperEl2Explore,
	MenuDeveloperEl3,
	MenuDeveloperElTitle,
	MenuDeveloperEl4,
	MenuProtocol,
	MenuProtocolTitle,
	MenuProtocolRest,
	MenuProtocolEl1,
	MenuProtocolEl1Title,
	MenuProtocolEl1Description,
	MenuProtocolEl1Explore,
	MenuProtocolEl2,
	MenuProtocolElTitle,
	MenuProtocolElDescription,
	MenuProtocolEl3,
	MenuProtocolEl4,
	MenuDeveloperElLeft,
	MenuDeveloperEl1Right,
	MenuDeveloperEl1Rest,
		...
		<MenuContainerWrap>
			<MenuContainerBackground>
				<MenuContainer>
					...
					<MenuIcon>
						<span>
							<svg
								fill='white'
								className='Icons__TwitterIcon-sc-1j8lcd8-2 doppSY'
								viewBox='0 0 32 32'
						...
						<span>
							<svg
								fill='white'
								className='Icons__GithubIcon-sc-1j8lcd8-4 gYAtDy'
								viewBox='0 0 24 24'
								xmlns='http://www.w3.org/2000/svg'>
						...
						<span>
							<svg
								fill='white'
								className='Icons__DiscordIcon-sc-1j8lcd8-1 kDrcru'
								viewBox='0 0 71 55'
								xmlns='http://www.w3.org/2000/svg'>
				...
				<MenuCount>
					<MenuCountAll>
						<MenuCountEl>
							<MenuCountElTitle>$679B+</MenuCountElTitle>
							<MenuCountElDescription>Trade Volume</MenuCountElDescription>
						</MenuCountEl>
						<MenuCountEl>
							<MenuCountElTitle>81M+</MenuCountElTitle>
							<MenuCountElDescription>All Time Trades</MenuCountElDescription>
						</MenuCountEl>
						<MenuCountEl>
							<MenuCountElTitle>300+</MenuCountElTitle>
							<MenuCountElDescription>Integrations</MenuCountElDescription>
						</MenuCountEl>
						<MenuCountEl>
							<MenuCountElTitle>4,400+</MenuCountElTitle>
							<MenuCountElDescription>
								Community Delegates
							</MenuCountElDescription>
						</MenuCountEl>
			...
			<MenuEcoSystem>
				<MenuEcoSystemLeft>
					<MenuEcoSystemLeftTitle>UNISWAP ECOSYSTEM →</MenuEcoSystemLeftTitle>
					<MenuEcoSystemLeftDescription>
				...
				<MenuEcoSystemRight>
					<MenuEcoSystemRightLogo>
						<MenuEcoSystemRightLogoTitle>300+</MenuEcoSystemRightLogoTitle>
						<MenuEcoSystemRightLogoDescription>
							Integrations
						</MenuEcoSystemRightLogoDescription>
						<MenuEcoSystemRightExplore>Explore all ↗</MenuEcoSystemRightExplore>
					</MenuEcoSystemRightLogo>
				</MenuEcoSystemRight>
			</MenuEcoSystem>

			<MenuDeveloper>
				<MenuDeveloperTitle>DEVELOPERS →</MenuDeveloperTitle>
				<MenuDeveloperRest>
					<MenuDeveloperElLeft>
						<MenuDeveloperEl1>
							<MenuDeveloperEl1Title>
							...
							<MenuDeveloperEl1Explore>Documentation ↗</MenuDeveloperEl1Explore>
						</MenuDeveloperEl1>
						<MenuDeveloperEl1Rest>
							<MenuDeveloperEl3>
								<MenuDeveloperElTitle>
									<span>V3 Whitepaper</span> <span>{"↗"}</span>
								</MenuDeveloperElTitle>
							</MenuDeveloperEl3>
							<MenuDeveloperEl4>
								<MenuDeveloperElTitle>
			...
			<MenuProtocol>
				<MenuProtocolTitle>PROTOCOL GOVERNANCE {"->"}</MenuProtocolTitle>
				<MenuProtocolRest>
					<MenuProtocolEl1>
						<MenuProtocolEl1Title>
						...
						<MenuProtocolEl1Explore>Read more ↗</MenuProtocolEl1Explore>
					</MenuProtocolEl1>
					<MenuProtocolEl2>
						<MenuProtocolElTitle>Governance Forum {" ↗"}</MenuProtocolElTitle>
						<MenuProtocolElDescription>
